  ...
  return (
    <>
      <div className="banner_1_main_container">
        ...
        <div className="home_wall">
          <div class="home__wall-box" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        ...
        <div className="home_wall_cont third">
